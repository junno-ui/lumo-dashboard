<template>
  <div class="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 font-sans">
    ...
    <div class="hidden lg:flex relative flex-col justify-between bg-linear-to-br from-primary-900 to-primary-950 p-12 text-white min-h-screen overflow-hidden">
      <div class="absolute top-0 right-0 w-96 h-96 bg-accent-500/20 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
      <div class="absolute bottom-0 left-0 w-80 h-80 bg-primary-700/30 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>
      ...
      <div class="relative z-10 flex items-center gap-3">
        ...
        <span class="text-2xl font-bold tracking-wider">Fleet</span>
      </div>

      <div class="relative z-10 max-w-lg">
        <h1 class="text-5xl lg:text-6xl font-bold leading-tight mb-8">
          Welcome<br />Back to Fleet
        </h1>
